export const Bio = {
    ...
    description: "I am experienced developer who likes to create efficient, reliable and fast software by breaking the problem statement in smaller chunks. I like to collaborate with people and create an impact using technology.",
...
export const skills =   [
    ...
    export const experiences = [
...

      {
        ...
        date: "10,June2024 - 16 August,2024",
        desc: "Develop a backend re-staking engine that allows users to re-stake their L2 Starknet assets to Ethereum L1 and earn the yield.Reduce Hashstack Blog hosting cost to zero by migrating it from Ghost CMS to Hugo.",
        skills: [
          "Express.js",
          "NodeJs",
          "Socket.io",
      ...
      },
      {
        ...
        desc: "Write tests on Jmeter and LoadRunner to perform load testing and performance testing of various in-house applications developed",
        skills: [
          "LoadRunner",
          "Jmeter",
